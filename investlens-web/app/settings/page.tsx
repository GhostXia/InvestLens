...
export default function SettingsPage() {
    const { apiKey, setApiKey, quantModeEnabled, setQuantModeEnabled } = useSettingsStore()
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    <div className="grid w-full max-w-sm items-center gap-1.5">
                        <Label htmlFor="api-key">OpenAI / Compatible API Key</Label>
                        <Input
                            type="password"
                            id="api-key"
                            placeholder="sk-..."
                        ...
                        <p className="text-xs text-muted-foreground">
                            Supports OpenAI, DeepSeek, or local proxies via Base URL (config in .env for now).
                        </p>
                    </div>
                </CardContent>
            </Card>
